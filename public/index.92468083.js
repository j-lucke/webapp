...
const $3da87ddc4a220fcd$var$CARD_SIZE = 200;
//--------------------------------------------------------
//------------ global variables ---------------------------
//---------------------------------------------------------
let $3da87ddc4a220fcd$var$i;
let $3da87ddc4a220fcd$var$list = [];
let $3da87ddc4a220fcd$var$listNodes = [];
let $3da87ddc4a220fcd$var$records = [];
//---------------------------------------------------------
//---------------- utilities ------------------------------
//---------------------------------------------------------
...
function $3da87ddc4a220fcd$var$removePlayer(player) {
    for($3da87ddc4a220fcd$var$i = 0; $3da87ddc4a220fcd$var$i < $3da87ddc4a220fcd$var$list.length; $3da87ddc4a220fcd$var$i++)if ($3da87ddc4a220fcd$var$list[$3da87ddc4a220fcd$var$i].id == player.id) {
        ...
        $3da87ddc4a220fcd$var$records.splice($3da87ddc4a220fcd$var$i, 1);
    }
}
//---------------------------------------------------------
//--------  load master list of players -------------------
//---- in order of twitter followers (descending) ---------
let $3da87ddc4a220fcd$var$masterList = [];
...
$3da87ddc4a220fcd$var$masterListRequest.onload = function() {
    ...
    console.log($3da87ddc4a220fcd$var$masterList);
};
...
$3da87ddc4a220fcd$var$listAll.addEventListener("click", ()=>{
    ...
    console.log($3da87ddc4a220fcd$var$fullList.style.display);
...
$3da87ddc4a220fcd$var$add.addEventListener("click", ()=>{
    ...
    $3da87ddc4a220fcd$var$masterList.forEach((p)=>{
        if (p.first_name.toUpperCase() == names[0].toUpperCase() && p.last_name.toUpperCase() == names[1].toUpperCase()) $3da87ddc4a220fcd$var$loadPlayer(p);
    });
});
...
$3da87ddc4a220fcd$var$clear.addEventListener("click", ()=>{
    ...
    for($3da87ddc4a220fcd$var$i = max - 1; $3da87ddc4a220fcd$var$i >= 0; $3da87ddc4a220fcd$var$i--){
        ...
        $3da87ddc4a220fcd$var$records.pop();
        $3da87ddc4a220fcd$var$listNodes.pop();
    }
});


//# sourceMappingURL=index.92468083.js.map
