...
function $9255a96f441295c6$var$createNamePlate(myMan) {
    ...
    const index = $9255a96f441295c6$var$masterList.findIndex((x)=>x.id == myMan.id);
    followers.innerHTML = `${myMan.current_count} followers (${$9255a96f441295c6$var$printOrdinal(index + 1)})`;
...
async function $9255a96f441295c6$var$loadPlayer(playerId) {
    ...
    console.log($9255a96f441295c6$var$masterList);
    player = $9255a96f441295c6$var$masterList[index];
    ...
    const chart = await $9255a96f441295c6$var$createFollowersGraph(player);
...
//# sourceMappingURL=index.39e9cb57.js.map
